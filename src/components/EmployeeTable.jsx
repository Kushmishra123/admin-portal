...
const EmployeeTable = ({ onEdit, onViewDetails }) => {
          ...
          <tbody>
            {filtered.map(emp => (
              <tr key={emp.id}>
                ...
                <td>
                  <a href="#" onClick={(e) => { e.preventDefault(); onViewDetails && onViewDetails(emp); }} style={{ color: '#3b82f6', textDecoration: 'none', fontWeight: 500 }}>
                    {emp.name}
                  </a>
                </td>
                ...
                <td>
                  <div style={{ display: 'flex', gap: 8 }}>
                    <button style={{
                      ...
                      transition: 'all 0.2s'
                    }} onClick={() => onEdit && onEdit(emp)} title="Edit Employee">
                    ...
                    <button style={{
                      ...
                      cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center',
                      transition: 'all 0.2s'
                    }} title="Delete Employee" onClick={() => deleteEmployee(emp.id)}>
                      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
